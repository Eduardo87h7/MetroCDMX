<div class="barraNav" class="col-md-12" class="col-sm-8">
    <br>
    <nav class="main-menu" class="col-md-12" class="col-sm-8">
        <ul>
            <li>
                <a href="/MetroCDMX/my/admin.php">
                    <i class="fa fa-2x">
            ...
            <li class="has-subnav" data-bs-toggle="modal" data-bs-target="#myModala">
                <a href="#">
                    <i class="fa  fa-2x">
            ...
            <li class="has-subnav" onclick="verarchivos()">
                <a href="#">
                    <i class="fa  fa-2x">
