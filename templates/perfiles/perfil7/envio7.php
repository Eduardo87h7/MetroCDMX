  ...
  <div class="container mt-3">
    <div class="card shadow-lg  rounded">
      <div class="card-header">
        <a href="/MetroCDMX/perfil7.php" class="btn btn-primary">regresar</a> Envio de Informacion
      </div>
      <div class="card-body">
        <h5 class="card-title">Selecciona y Envia</h5>
        <hr>

        <form method="POST" action="subir-arch7.php" action="subir" enctype="multipart/form-data">
          ...
          ?>
          <select name="area7" class="form-select" aria-label="Default select example">
          ...
          <input value="LINEA-7" name="linea" readonly>
